...
<head>
    ...
    <title>Dashboard DG - Version Unifiée</title>
    ...
    <style>
        ...
        * {
        ...
        /* Toutes les tâches - Style spécifique */
        .all-tasks-list {
            display: flex;
...
<body>
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                ...
                <li class="menu-item" data-target="toutes-taches">Toutes les tâches</li>
        ...
        <div class="main-content">
            ...
            <div id="accueil" class="content-section">
                <div class="welcome-section">
                    <h1>Dashboard Direction Générale</h1>
                    <p>Gérez vos responsables, accountables, tâches et projets en toute simplicité</p>
                </div>
                ...
                <div class="actions-grid">
                    ...
                    <div class="action-card import">
                        ...
                        <p>Importez vos données depuis des fichiers Excel</p>
                        <div class="buttons">
                            ...
                            <button class="btn btn-success" id="importTachesHome">Importer tâches</button>
                    ...
                    <div class="action-card export">
                        ...
                        <p>Exportez vos données vers Excel pour sauvegarde ou partage</p>
                        <div class="buttons">
                            ...
                            <button class="btn btn-primary" id="exportTachesHome">Exporter tâches</button>
                    ...
                    <div class="action-card">
                        ...
                        <p>Créez un fichier HTML autonome avec toutes vos données</p>
                        <div class="buttons">
                    ...
                    <div class="action-card danger">
                        ...
                        <p>Actions de gestion avancées</p>
                        <div class="buttons">
                            <button class="btn btn-danger" id="resetDataHome">Réinitialiser</button>
                        </div>
                    </div>
                </div>

                <!-- Zones d'import cachées -->
                <div class="file-import" style="display: none; margin-top: 30px;" id="responsablesImportArea">
                    <h3>Importer les responsables</h3>
                    <p>Format attendu : Colonnes [ID, Nom, Rôle]</p>
                    <input type="file" id="responsablesExcelFile" accept=".xlsx, .xls">
                    <div class="import-actions">
                        <button class="btn btn-success" id="uploadResponsablesExcel">Importer les données</button>
                ...
                <div class="file-import" style="display: none; margin-top: 30px;" id="accountablesImportArea">
                    ...
                    <div class="import-actions">
                        <button class="btn btn-success" id="uploadAccountablesExcel">Importer les données</button>
                ...
                <div class="file-import" style="display: none; margin-top: 30px;" id="tachesImportArea">
                    ...
                    <div class="import-actions">
                        <button class="btn btn-success" id="uploadTachesExcel">Importer les données</button>
                ...
                <div class="file-import" style="display: none; margin-top: 30px;" id="projetsImportArea">
                    ...
                    <p>Format attendu : Colonnes [ID, Responsable, Accountable, Titre, Description, Date Début, Date Fin]</p>
                    <input type="file" id="projetsExcelFile" accept=".xlsx, .xls">
                    <div class="import-actions">
                        <button class="btn btn-success" id="uploadProjetsExcel">Importer les données</button>
            ...
            <div id="responsables" class="content-section" style="display: none;">
                ...
                <div class="card">
                    <div class="responsables-list" id="responsablesContainer">
                        <!-- Les responsables seront chargés ici dynamiquement -->
                    </div>
                </div>
            </div>
            ...
            <div id="taskDetails" class="content-section" style="display: none;">
                <div class="header">
                    <h2 id="taskDetailsTitle">Détails de la tâche</h2>
                    <div>
                        <button class="btn btn-danger" id="deleteTask">Effacer la tâche</button>
                ...
                <div class="card">
                    ...
                    <div class="file-import">
                        <p>Mettre à jour cette tâche via fichier Excel</p>
                        <input type="file" id="taskExcelFile" accept=".xlsx, .xls">
                        <div class="import-actions">
                            <button class="btn btn-primary" id="uploadTaskExcel">Importer</button>
                            <button class="btn btn-secondary" id="exportTaskExcel">Exporter cette tâche</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function initialiserEvenements() {
            ...
            // Boutons d'upload (importer les données)
            ...
            // FONCTION RÉINITIALISER CORRIGÉE
            ...
            // Événements pour les détails de tâche
        ...
        function exporterResponsables() {
            ...
            try {
                ...
                alert(`${responsablesData.length} responsables exportés avec succès !`);
            } catch (error) {
        ...
        function exporterAccountables() {
            ...
            try {
                if (!accountablesData || accountablesData.length === 0) {
                    alert('Aucun accountable à exporter.');
                    return;
                }
                ...
                alert(`${accountablesData.length} accountables exportés avec succès !`);
            } catch (error) {
        ...
        function exporterTaches() {
            ...
            try {
                ...
                alert(`${allTasks.length} tâches exportées avec succès !`);
            } catch (error) {
                console.error('Erreur export tâches:', error);
                alert('Erreur lors de l\'export des tâches: ' + error.message);
            }
        }
        ...
        function exporterProjets() {
            ...
            try {
                ...
                const data = [['ID', 'Responsable', 'Accountable', 'Titre', 'Description', 'Date Début', 'Date Fin']];
                ...
                alert(`${allProjets.length} projets exportés avec succès !`);
            } catch (error) {
    ...
    // Créer un contenu avec SEULEMENT les données JSON
    ...
    alert('✅ Export réussi ! Fichier JSON téléchargé.');
}
...
👥 Responsables: ${importedData.responsables.length}
👤 Accountables: ${importedData.accountables.length}  
✅ Tâches: ${Object.values(importedData.tasks).flat().length}
📋 Projets: ${Object.values(importedData.projets).flat().length}
...
Confirmer l'import ?`;
                ...
                alert('❌ ERREUR : Fichier JSON invalide.\n\nVérifiez que vous avez sélectionné le bon fichier d\'export.');
    ...
    fileInput.click();
        ...
        function reinitialiserDonnees() {
            ...
            if (confirm('Êtes-vous ABSOLUMENT sûr de vouloir réinitialiser TOUTES les données ?\n\nCette action supprimera définitivement tous les responsables, accountables, tâches et projets.\n\nCette action est IRREVERSIBLE !')) {
                try {
                    // Vérifier que localStorage est accessible
                    if (typeof(Storage) === "undefined") {
                        alert("Erreur: Le stockage local n'est pas supporté par ce navigateur.");
                        return;
                    }
                    ...
                    sauvegarderDonnees();
                    console.log('Données sauvegardées après réinitialisation');
        ...
        function afficherResponsables() {
            ...
            if (responsablesData.length === 0) {
                container.innerHTML = '<p style="text-align: center; color: #666; padding: 20px;">Aucun responsable trouvé.</p>';
                return;
            }
            ...
            responsablesData.forEach(responsable => {
                ...
                card.innerHTML = `
                    ...
                    <div>
                        <span class="task-count" data-id="${responsable.id}" data-type="taches">${responsable.tasksCount} tâche(s)</span>
                        <span class="project-count" data-id="${responsable.id}" data-type="projets">${responsable.projectsCount} projet(s)</span>
                    </div>
                `;
                
                // Clic sur la carte -> afficher les tâches (comportement par défaut)
                card.addEventListener('click', function() {
                    afficherTachesResponsable(responsable.id, responsable.name);
                });
                
                // Clic sur le compteur de tâches -> afficher les tâches
        ...
        function afficherAccountables() {
            ...
            if (accountablesData.length === 0) {
                container.innerHTML = '<p style="text-align: center; color: #666; padding: 20px;">Aucun accountable trouvé.</p>';
                return;
            }
            ...
            accountablesData.forEach(accountable => {
                ...
                card.innerHTML = `
                    ...
                    <div>
                        <span class="task-count accountable-task-count" data-id="${accountable.id}" data-type="taches">${accountable.tasksCount} tâche(s)</span>
        ...
        function afficherToutesTaches() {
            ...
            titre.textContent = 'Toutes les tâches';
            container.innerHTML = '';
        ...
        function afficherTachesResponsable(responsableId, responsableName) {
            const container = document.getElementById('allTasksContainer');
            const titre = document.getElementById('tachesTitle');
            titre.textContent = `Tâches du responsable: ${responsableName}`;
            container.innerHTML = '';
        ...
        function afficherTachesAccountable(accountableId, accountableName) {
            const container = document.getElementById('allTasksContainer');
            const titre = document.getElementById('tachesTitle');
            titre.textContent = `Tâches de l'accountable: ${accountableName}`;
            container.innerHTML = '';
        ...
        function afficherProjets() {
            ...
            if (tousProjets.length === 0) {
                container.innerHTML = '<p style="text-align: center; color: #666; padding: 20px;">Aucun projet trouvé.</p>';
                return;
            }
        ...
        function afficherListeTaches(taches, container) {
            if (taches.length === 0) {
                container.innerHTML = '<p style="text-align: center; color: #666; padding: 20px;">Aucune tâche trouvée.</p>';
                return;
            }
            ...
            taches.forEach(tache => {
                ...
                // Clic sur le nom de la tâche -> afficher les détails
                ...
                taskName.addEventListener('click', function() {
                    ...
                    document.getElementById('taskDetailsTitle').textContent = `Détails: ${tache.title}`;
                    showSection('taskDetails');
                });
                
                // Clic sur le responsable -> afficher ses tâches
                ...
                // Clic sur l'accountable -> afficher ses tâches
        ...
        function afficherListeProjets(projets, container) {
            ...
            projets.forEach(projet => {
                ...
                // Clic sur le nom du projet -> afficher les détails
        ...
        function repairExistingData() {
            ...
            responsablesData.forEach(responsable => {
                ...
                if (!responsable.role) responsable.role = "Rôle non défini";
            });
            ...
            accountablesData.forEach(accountable => {
                ...
                if (!accountable.role) accountable.role = "Rôle non défini";
            });
        ...
        function formaterDate(dateString) {
            ...
            if (typeof dateString === 'string') {
                // Vérifier si c'est déjà au format français
                if (dateString.match(/^\d{2}\/\d{2}\/\d{4}$/)) {
                    return dateString;
                }
                
                // Gérer les dates avec heure
                ...
                // Gérer le format ISO avec heure
            ...
            if (typeof dateString === 'number') {
                try {
                    // Les dates Excel sont des nombres où 1 = 1900-01-01
        ...
        function formaterDatePourExport(dateString) {
            ...
            // Pour les autres formats, essayer de créer une Date
            try {
                const date = new Date(dateString);
        ...
        // Les autres fonctions d'import/export et de gestion des données restent identiques
        // [Elles sont conservées mais non affichées pour garder le code concis]
        ...
        function importerResponsables() {
            ...
            reader.onload = function(e) {
                try {
                    ...
                    const expectedHeaders = ['ID', 'Nom', 'Rôle'];
                    
                    if (!expectedHeaders.every(h => headers.includes(h))) {
                        alert('Format de fichier incorrect. Colonnes attendues: ID, Nom, Rôle');
                        return;
                    }
                    ...
                    for (let i = 1; i < jsonData.length; i++) {
                        ...
                        if (row.length >= 3 && row[0] && row[1]) {
                            newResponsables.push({
                                id: row[0].toString(),
                                name: row[1].toString(),
                                role: row[2] ? row[2].toString() : 'Rôle non défini',
                                tasksCount: 0,
                                projectsCount: 0
                            });
                        }
                    ...
                    if (newResponsables.length === 0) {
                        alert('Aucun responsable valide trouvé dans le fichier');
                        return;
                    }
                    ...
                    alert(`${newResponsables.length} responsables importés avec succès !`);
            ...
            reader.onload = function(e) {
                try {
                    ...
                    if (newAccountables.length === 0) {
                        alert('Aucun accountable valide trouvé dans le fichier');
                        return;
                    }
                    ...
                    alert(`${newAccountables.length} accountables importés avec succès !`);
        ...
        try {
            ...
            for (let i = 1; i < jsonData.length; i++) {
                ...
                if (row.length >= 5 && row[0] && row[1] && row[2] && row[3]) {
                    ...
                    if (!responsable) {
                        console.warn(`Responsable "${responsableName}" non trouvé pour la tâche ${taskId}`);
                        continue;
                    }
                    
                    if (!accountable) {
                        console.warn(`Accountable "${accountableName}" non trouvé pour la tâche ${taskId}`);
                        continue;
                    }
                    ...
                    if (existingTask) {
                        // MISE À JOUR : Fusionner sans écraser les données détaillées
                        ...
                        // Remplacer la tâche dans le tableau
                        ...
                        // Si le responsable a changé, déplacer la tâche
                        ...
                        const newTask = {
                            ...
                            title: title,
                            description: description
                            // Les champs détaillés seront undefined et pourront être ajoutés plus tard
                        };
            ...
            if (importedCount === 0 && updatedCount === 0) {
                alert('Aucune tâche valide importée. Vérifiez que les responsables et accountables existent.');
                return;
            }
            ...
            if (importedCount > 0) {
                message += `${importedCount} nouvelle(s) tâche(s) importée(s). `;
            }
            if (updatedCount > 0) {
                message += `${updatedCount} tâche(s) existante(s) mise(s) à jour (informations de base uniquement).`;
            }
            alert(message);
...
// Fonction utilitaire pour fusionner les données de tâche sans écraser les champs détaillés
function fusionnerTache(existingTask, newData) {
    return {
        ...
        // Conserver les champs détaillés s'ils existent
...
// Fonction pour trouver une tâche dans toutes les données
function trouverTacheParId(taskId) {
    ...
    return { task: null, responsableId: null };
        ...
        function importerProjets() {
            ...
            reader.onload = function(e) {
                try {
                    ...
                    const headers = jsonData[0];
                    const expectedHeaders = ['ID', 'Responsable', 'Accountable', 'Titre', 'Description', 'Date Début', 'Date Fin'];
                    
                    if (!expectedHeaders.every(h => headers.includes(h))) {
                        alert('Format de fichier incorrect. Colonnes attendues: ID, Responsable, Accountable, Titre, Description, Date Début, Date Fin');
                        return;
                    }
        ...
        const endDate = normaliserDate(row[6]);
                            ...
                            if (!responsable) {
                                console.warn(`Responsable "${responsableName}" non trouvé pour le projet ${projetId}`);
                                continue;
                            }
                            
                            if (!accountable) {
                                console.warn(`Accountable "${accountableName}" non trouvé pour le projet ${projetId}`);
                                continue;
                            }
                    ...
                    if (importedCount === 0) {
                        alert('Aucun projet valide importé. Vérifiez que les responsables et accountables existent.');
                        return;
                    }
                    ...
                    alert(`${importedCount} projets importés avec succès !`);
    ...
    reader.onload = function(e) {
        try {
            ...
            // Chercher la tâche avec l'ID correspondant
            let taskFound = false;
            ...
            for (let i = 1; i < jsonData.length; i++) {
                ...
                if (row.length >= 4 && row[0] && row[0].toString() === currentTaskId) {
                    ...
                    // Lignes supplémentaires avec seulement des risques/plans
                    // Vérifier si c'est une ligne de risque (colonne 8 et/ou 9 remplies)
                    ...
                    if (hasRisque || hasPlan) {
                        ...
                        // Si la ligne n'a ni risque ni plan, on arrête de chercher
                        break;
                    }
                }
            }
            ...
            if (!taskFound) {
                alert('Tâche non trouvée dans le fichier. Vérifiez que l\'ID correspond.');
                return;
            }
            
            // Maintenant, traiter les données de la tâche principale
            ...
            if (!responsable) {
                alert(`Responsable "${responsableName}" non trouvé`);
                return;
            }
            
            if (!accountable) {
                alert(`Accountable "${accountableName}" non trouvé`);
                return;
            }
            
            // Mettre à jour la tâche avec les nouveaux champs
            ...
            if (taskIndex !== -1) {
                ...
                alert(`Tâche mise à jour avec succès ! ${allRisquesEtPlans.length} risque(s) importé(s).`);
            }
            
        } catch (error) {
            console.error('Erreur import tâche détaillée:', error);
            alert('Erreur lors de l\'import: ' + error.message);
        }
    };
    ...
    // Ajouter les risques et plans supplémentaires sur les lignes suivantes
    ...
    const ws = XLSX.utils.aoa_to_sheet(data);
    const wb = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(wb, ws, "Tâche détaillée");
    XLSX.writeFile(wb, `tache_detaille_${task.id}_export.xlsx`);
}



        // Fonctions pour la gestion des détails de tâche
function loadTaskDetails(responsableId, taskId) {
    ...
    if (!task) {
        container.innerHTML = '<p>Tâche non trouvée</p>';
        return;
    }
 ...
 // Dans loadTaskDetails, remplacer les références directes par des vérifications
container.innerHTML = `
    ...
    <div class="detail-section">
        ...
        <div class="detail-item">
            ...
            <div class="detail-value">${responsable ? responsable.name : 'Non assigné'}</div>
        </div>
        <div class="detail-item">
            <div class="detail-label">Accountable</div>
            <div class="detail-value">${accountable ? accountable.name : 'Non assigné'}</div>
        </div>
        <div class="detail-item">
                ...
                task.risquesEtPlans.map((item, index) => `
                    <div class="risk-item">
                        <div class="risk-header">
                            ...
                            <button class="remove-risk" data-index="${index}">×</button>
                        </div>
                        <div class="detail-item">
...
function makeEditable(element) {
    ...
    if (field === 'risque' || field === 'plan') {
        // Édition d'un risque ou plan spécifique
        const isTextArea = field === 'plan'; // Les plans peuvent être longs
        ...
        function saveEditableValue(element, field, value) {
            ...
            if (task) {
                task[field] = value;
                sauvegarderDonnees();
                loadTaskDetails(currentResponsableId, currentTaskId); // Recharger pour afficher la valeur sauvegardée
            }
        }

        function saveTaskDetails() {
            // Les modifications sont déjà sauvegardées via makeEditable
        ...
        function afficherDetailsProjet(projet) {
            ...
            container.innerHTML = `
                <div class="project-details">
                    <h3>Détails du projet: ${projet.title}</h3>
                            ...
                            ${deadlines.map((deadline, index) => `
                                <div class="deadline-item">
                                    <div class="deadline-info">
                                        <strong>${deadline.title || 'Échéance sans titre'}</strong>
            ...
            // Gestion de la suppression des échéances
        ...
        function ajouterEcheance(projetId) {
            const titre = prompt('Titre de l\'échéance:');
            if (!titre) return;
            
            const date = prompt('Date de l\'échéance (YYYY-MM-DD):');
            if (!date) return;
...
// FONCTION D'EXPORT HTML STATIQUE SIMPLIFIÉE
function exporterHTMLStatique() {
    ...
    try {
        ...
        // Créer le contenu HTML statique
...
<body>
    <div class="header">
        <h1>📊 Tableau de Bord - Version Consultation</h1>
        <p>Données exportées le ${new Date().toLocaleDateString('fr-FR')}</p>
    </div>
        ...
        ${responsablesData.length === 0 ? 
            ...
            responsablesData.map(resp => `
                <div class="card">
                    ...
                    <div>
                        <span class="badge">${resp.tasksCount || 0} tâches</span>
        ...
        ${accountablesData.length === 0 ? 
            ...
            accountablesData.map(acc => `
                <div class="card">
                    ...
                    <div>
                        <span class="badge badge-accountable">${acc.tasksCount || 0} tâches</span>
    ...
    <div class="section">
        ...
        ${toutesTaches.length === 0 ? 
            '<p style="text-align: center; color: #7f8c8d; padding: 20px;">Aucune tâche</p>' :
            toutesTaches.map(tache => {
                const responsable = responsablesData.find(r => r.id === tache.responsableId);
                const accountable = accountablesData.find(a => a.id === tache.accountableId);
                return `
                    <div class="task-item">
                        <strong>${tache.title || 'Tâche sans titre'}</strong>
    ...
    <div style="text-align: center; margin-top: 40px; padding: 20px; color: #7f8c8d; border-top: 1px solid #ecf0f1;">
        <p>Document généré automatiquement - Tableau de Bord DG</p>
    </div>
</body>
</html>`;
        ...
        alert('✅ Export HTML statique réussi ! Fichier téléchargé.');
